...
type Customer struct {
	...
	CuLEI                        *string                `gorm:"column:cu_lei;type:text"`
...
type BusinessRelationship struct {
	...
	BrCustomerID       uint        `gorm:"column:br_customer_id;not null;index:idx_business_relationship_customer;uniqueIndex:uq_br_customer_entity"`
	BrEntityID         uint        `gorm:"column:br_entity_id;not null;index:idx_business_relationship_entity;uniqueIndex:uq_br_customer_entity"`
...
type SuspiciousReport struct {
	...
	SrFiuNotificationDate time.Time   `gorm:"column:sr_fiu_notification_date;type:date;not null;index:idx_suspicious_report_notification_date"`
...
type SanctionScreening struct {
	...
	SsScreeningDate time.Time   `gorm:"column:ss_screening_date;type:date;not null;index:idx_sanction_screening_date"`
