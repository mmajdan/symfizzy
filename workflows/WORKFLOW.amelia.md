...
{"summary":"Brief description of what was implemented","files_changed":["file1.rb","file2.rb"],"tests_run":["bin/rails test"],"notes":["Any important notes"]}
...
Example:
SYMPHONY_SUMMARY_START
{"summary":"Fixed user authentication bug in SessionsController","files_changed":["app/controllers/sessions_controller.rb","app/models/user.rb"],"tests_run":["bin/rails test test/controllers/sessions_controller_test.rb"],"notes":["Also updated related tests"]}
SYMPHONY_SUMMARY_END
