...
For changes made to symphony to test run the web and symphony locally.  Open the board autopilot.re locally add the card with instructions for the agent to create file cnamed CARD-<??> refereing to the card processed with the CARD description as file contents.
